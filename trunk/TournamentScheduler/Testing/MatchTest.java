...
public class MatchTest {
	...
	public void testToString() {
		...
		Team t1 = new Team("T1", new Player("P1", tenToThree));
		Team t2 = new Team("T2", new Player("P2", tenToThree));
		Court c1 = new Court("C1", "V1", tenToThree);
	...
	public void testAvailableTimes() {
		...
		Court c1 = new Court("C1", "V1", sixToEleven, elevenToThree, threeToFive);
		Player p1a = new Player("P1a", sixToEleven);
		Player p1b = new Player("P1b", sixToEleven);
		Player p2a = new Player("P2a", tenToFour);
		Player p2b = new Player("P2b", tenToFour);
		Player p3a = new Player("P3a", threeToFive);
		Player p3b = new Player("P3b", threeToFive);
		Player p4a = new Player("P4a", sixToEleven, elevenToThree, threeToFive);
		Player p4b = new Player("P4b", sixToEleven, elevenToThree, threeToFive);
